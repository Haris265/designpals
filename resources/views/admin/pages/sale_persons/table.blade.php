    ...
    <div class="row">
        <div class="card">
            <h5 class="card-header row">
                ...
                <div class="col-md-2">
                    <a class="btn btn-primary" href="{{ route('admin.add.sale') }}">Add Sale Person</a>
                </div>
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($sale_persons as $sale_person)
                            <tr>
                                ...
                                <td>
                                    <a class="fa fa-edit"
                                        href="{{ route('admin.edit.sale', ['id' => $sale_person->id]) }}">
                                    </a>
                                    <a class="fa fa-trash"
                                        href="{{ route('admin.delete.sale', ['id' => $sale_person->id]) }}">
                                    </a>
                                    <a class="fa fa-money"
                                        href="{{ route('admin.sale.amount', ['id' => $sale_person->id]) }}" target="_blank">
                                    </a>
                                </td>
