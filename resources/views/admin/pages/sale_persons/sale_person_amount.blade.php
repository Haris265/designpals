...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="card">
            <h5 class="card-header">Sale Person Amount</h5>
            <div class="card-body">
                <form action="{{ route('admin.sale.amount.process') }}" method="post" class="row">
                    @csrf
                    <input type="hidden" name="saler_id" value="{{$sale_amount->id}}">
