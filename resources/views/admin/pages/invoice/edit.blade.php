...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.update.invoice') }}" method="post" class="row">
                    @csrf
                    <input type="hidden" name="id" @if(!empty($invoice)) value="{{$invoice->id}}" @endif>
                    <input type="hidden" name="invoice_char" id="invoice_char" value="{{$invoice->invoice_char}}">
                    <input type="hidden" name="invoice_numb" id="invoice_numb" value="{{$invoice->invoice_numb}}">
