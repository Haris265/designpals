...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.store.invoice') }}" method="post" class="row">
                    @csrf

                    <input type="hidden" name="invoice_char" id="invoice_char">
                    <input type="hidden" name="invoice_numb" id="invoice_numb">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" name="exludedDate" class="form-control">
